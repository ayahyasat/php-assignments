    ...
    <?php if (!strpos($_SERVER['SCRIPT_FILENAME'], 'index.php')) : ?>
        <style>
            header {
                ...
                height: <?= strpos($_SERVER['SCRIPT_FILENAME'], 'home.php')|| strpos($_SERVER['SCRIPT_FILENAME'], 'all_courses.php')||strpos($_SERVER['SCRIPT_FILENAME'], 'contact_us.php')|| strpos($_SERVER['SCRIPT_FILENAME'], 'about_us.php') ? 80 : 40 ?>vh;? 80 : 40 ?>vh
