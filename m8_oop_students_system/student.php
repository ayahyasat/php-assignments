...
class Student
{
    ...
    public function create($student_information)
    {
        ...
        $this->database->submit_query("INSERT INTO students (name, dob, phone, email, gender) VALUES ('$name','$dob','$phone','$email','$gender')");
    }

    public function get_students(): array
    {
        $students = array();
        $result = $this->database->submit_query("SELECT * FROM students");
